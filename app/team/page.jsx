    ...
    <div className="main-content">
      ...
      <div className="content">
        ...
        <div className="esquina">
          <h6 className="title">TALENTO HUMANO</h6>
        </div>
        <div className="diagonal">
          <h6 className="list">Conoce a Nuestro Personal</h6>
        </div>
      </div>
      <div id="a1" className="contet-services1">
        ...
        <div className="content-text">
          <h6 className="title">NUESTRO TALENTO HUMANO</h6>
          <p className="subtitle">Trabajando Por Una Gran Experiencia</p>
          <p className="p-text">
      ...
      <div className="contet-services1">
        ...
        ></Image>
        <div className="content-text">
          <h6 className="title">CALIDEZ HUMANA</h6>
          <p className="subtitle">
            Tu Atencion Es lo Mas Importante
          </p>
          <p className="p-text">
      ...
      <div className="contet-services1">
        ...
        ></Image>
        <div className="content-text">
          <h6 className="title">CAPACITACION CONSTANTE</h6>
          <p className="subtitle">
